	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			case 'spooky':
				...
				var hallowTex = Paths.getSparrowAtlas('halloween_bg', 'stages/$curStage');
			...
			case 'philly':
				...
				var bg:FNFSprite = new FNFSprite(-100).loadGraphic(Paths.image('sky', 'stages/$curStage'));
				bg.scrollFactor.set(0.1, 0.1);
				add(bg);

				var city:FNFSprite = new FNFSprite(-10).loadGraphic(Paths.image('city', 'stages/$curStage'));
				...
				for (i in 0...5)
				{
					var light:FNFSprite = new FNFSprite(city.x).loadGraphic(Paths.image('win' + i, 'stages/$curStage'));
			...
			case 'highway':
				...
				var skyBG:FNFSprite = new FNFSprite(-120, -50).loadGraphic(Paths.image('limoSunset', 'stages/$curStage'));
				...
				var overlayShit:FNFSprite = new FNFSprite(-500, -600).loadGraphic(Paths.image('limoOverlay', 'stages/$curStage'));
				...
				var limoTex = Paths.getSparrowAtlas('limoDrive', 'stages/$curStage');
			...
			case 'mall':
				...
				var bg:FNFSprite = new FNFSprite(-1000, -500).loadGraphic(Paths.image('bgWalls', 'stages/$curStage'));
				...
				upperBoppers.frames = Paths.getSparrowAtlas('upperBop', 'stages/$curStage');
				...
				var bgEscalator:FNFSprite = new FNFSprite(-1100, -600).loadGraphic(Paths.image('bgEscalator', 'stages/$curStage'));
				...
				var tree:FNFSprite = new FNFSprite(370, -250).loadGraphic(Paths.image('christmasTree', 'stages/$curStage'));
				...
				var fgSnow:FNFSprite = new FNFSprite(-600, 700).loadGraphic(Paths.image('fgSnow', 'stages/$curStage'));
				fgSnow.active = false;
				fgSnow.antialiasing = true;
				add(fgSnow);

				santa = new FNFSprite(-840, 150);
				santa.frames = Paths.getSparrowAtlas('santa', 'stages/$curStage');
			...
			case 'school':
				...
				var bgSchool:FNFSprite = new FNFSprite(repositionShit, 0).loadGraphic(Paths.image('weebSchool', 'stages/$curStage'));
				bgSchool.scrollFactor.set(0.6, 0.90);
				add(bgSchool);

				var bgStreet:FNFSprite = new FNFSprite(repositionShit).loadGraphic(Paths.image('weebStreet', 'stages/$curStage'));
				bgStreet.scrollFactor.set(0.95, 0.95);
				add(bgStreet);

				var fgTrees:FNFSprite = new FNFSprite(repositionShit + 170, 130).loadGraphic(Paths.image('weebTreesBack', 'stages/$curStage'));
				fgTrees.scrollFactor.set(0.9, 0.9);
				add(fgTrees);

				var bgTrees:FNFSprite = new FNFSprite(repositionShit - 380, -800);
				var treetex = Paths.getPackerAtlas('weebTrees', 'stages/$curStage');
				...
				treeLeaves.frames = Paths.getSparrowAtlas('petals', 'stages/$curStage');
			...
			default:
				...
				var stageFront:FNFSprite = new FNFSprite(-650, 600).loadGraphic(Paths.image('stagefront', 'stages/$curStage'));
				...
				var stageCurtains:FNFSprite = new FNFSprite(-500, -300).loadGraphic(Paths.image('stagecurtains', 'stages/$curStage'));
