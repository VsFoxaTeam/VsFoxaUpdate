...
class Character extends FNFSprite
{
	...
	public var characterType:String = GHOST;
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		if (FileSystem.exists('characters/$character/' + character + '.json'))
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('GF_assets', 'characters/$curCharacter');
				frames = tex;
			...
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('gfChristmas', 'characters/$curCharacter');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-car':
				tex = Paths.getSparrowAtlas('gfCar', 'characters/$curCharacter');
				frames = tex;
			...
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('gfPixel', 'characters/$curCharacter');
				frames = tex;
			...
			case 'gf-tankmen':
				frames = Paths.getSparrowAtlas('gfTankmen', 'characters/$curCharacter');
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('DADDY_DEAREST', 'characters/$curCharacter');
				frames = tex;
			...
			case 'spooky':
				...
				playAnim('danceRight');
			case 'mom':
				tex = Paths.getSparrowAtlas('Mom_Assets', 'characters/$curCharacter');
				frames = tex;
			...
			case 'mom-car':
				tex = Paths.getSparrowAtlas('momCar', 'characters/$curCharacter');
				frames = tex;
				...
				playAnim('idle');
			case 'monster':
				tex = Paths.getSparrowAtlas('Monster_Assets', 'characters/$curCharacter');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('monsterChristmas', 'characters/$curCharacter');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
				...
				playAnim('idle');
			case 'pico':
				tex = Paths.getSparrowAtlas('Pico_FNF_assetss', 'characters/$curCharacter');
				frames = tex;
			...
			case 'bf':
				frames = Paths.getSparrowAtlas('BOYFRIEND', 'characters/$curCharacter');
			...
			/*
				case 'bf-og':
					frames = Paths.getSparrowAtlas('og/BOYFRIEND', 'characters/$curCharacter');
			...
			case 'bf-dead':
				frames = Paths.getSparrowAtlas('BF_DEATH', 'characters/$curCharacter');
			...
			case 'bf-holding-gf':
				frames = Paths.getSparrowAtlas('bfAndGF', 'characters/$curCharacter');
			...
			case 'bf-holding-gf-dead':
				frames = Paths.getSparrowAtlas('bfHoldingGF-DEAD', 'characters/$curCharacter');
			...
			case 'bf-pixel':
				...
				flipX = true;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('bfPixelsDEAD', 'characters/$curCharacter');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('senpai', 'characters/$curCharacter');
			...
			case 'senpai-angry':
				...
				characterData.camOffsetX = -200;
			case 'spirit':
				frames = Paths.getPackerAtlas('spirit', 'characters/$curCharacter');
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('mom_dad_christmas_assets', 'characters/$curCharacter');
	...
	{
		var rawJson = File.getContent(Paths.getPath('characters/$char/' + char + '.json', TEXT));
		...
		if (FileSystem.exists('$characterPath.txt'))
